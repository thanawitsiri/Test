...
<table width="962" height="744" border="0" a>
  ...
  for($i=0;$i<=(int)$_SESSION["intLine"];$i++)
  {
	  ...
	  <tr>
		...
		<td><?php echo $objResult["Room_Name"];?></td>
        <td><img src="Staff/myfile/<? echo $objResult["Room_Picture"]; ?>" width="220" height="150" /></td>
 ...
 /        เบอร์ติดต่อ : <?php echo $result["Cus_Phone"];?> </p>
      ...
      <p>ราคารวม : <strong><?php echo number_format($SumTotal*3);?></strong> บาท</p>
      <p>ค่ามัดจำ : <strong><?php echo number_format($SumTotal*3/2);?></strong> บาท</p>
      <p>หมายเหตุ :
      ...
      <p>
        <input type="submit" name="button" id="button" onclick="MM_goToURL('parent','booking2.php');return document.MM_returnValue" value="เลือกเพิ่ม" />
