...
<?
	...
	{
	$sql="UPDATE tb_customer SET Cus_Name = '".$_POST[Cus_Name]."',
								 Cus_IDCard = '".$_POST[Cus_IDcard]."',
	...
	if($query)
	{
		$str="แก้ไขข้อมูลลูกค้าเสร็จสิ้น";
	} 
	else
	{
	$str="แก้ไขข้อมูลลูกค้าล้มเหลว";
	}
}
?>
...
<table width="1166" height="671" border="0" >
  ...
  <tr>
    <td width="189" height="201" align="left" valign="top" bgcolor="#999999"><h2>
      ...
      <p></p></td>
    <td width="967" align="center" valign="top" bgcolor="#CED8F6"><h4><? echo $str; ?></h4>
