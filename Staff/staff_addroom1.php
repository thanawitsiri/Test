...
{
		echo "สร้างข้อมูลห้องพักเสร็จสิ้น<br>";
		//*** Insert Record ***//
	...
	and $_POST[Room_Detail] != NULL
	and $_POST[Room_Type] != NULL
	and $_POST[Room_Price] != NULL
	and $_POST[Room_Status] != NULL
	and $_FILES["filUpload"]["name"] == NULL)
	{
	$strSQL = "INSERT INTO tb_room(Room_ID,Room_Name,Room_Type,Room_Detail,Room_Price,Room_Status) 
	VALUES ('NULL','".$_POST["Room_Name"]."','".$_POST["Room_Type"]."','".$_POST["Room_Detail"]."','".$_POST["Room_Price"]."',
	'".$_POST["Room_Status"]."')";
	$objQuery = mysql_query($strSQL);
	}elseif($_POST[Room_Name] != NULL
	and $_POST[Room_Detail] != NULL
	and $_POST[Room_Type] != NULL
	and $_POST[Room_Price] != NULL
	and $_POST[Room_Status] != NULL
	and $_FILES["filUpload"]["name"] != NULL)
	{
	$strSQL = "INSERT INTO tb_room(Room_ID,Room_Name,Room_Type,Room_Detail,Room_Price,Room_Status,Room_Picture) 
	VALUES ('NULL','".$_POST["Room_Name"]."','".$_POST["Room_Type"]."','".$_POST["Room_Detail"]."','".$_POST["Room_Price"]."',
	'".$_POST["Room_Status"]."','".$_FILES["filUpload"]["name"]."')";
	$objQuery = mysql_query($strSQL);
	}
	if($strSQL)
	{
		$stt = "สร้างข้อมูลห้องพักเสร็จสิ้น";
	} else
	{
		$stt = "สร้างข้อมูลห้องพักล้มเหลว กรุณากรอกข้อมูลให้ครบถ้วน";
	}
}
?>
...
<table width="1166" height="671" border="0" >
  ...
  <tr>
    <td width="189" height="201" align="left" valign="top" bgcolor="#999999"><h2>
      ...
      <p></p></td>
    <td width="967" align="center" valign="top" bgcolor="#CED8F6"><h4><br /><? echo $stt; ?></h4>
