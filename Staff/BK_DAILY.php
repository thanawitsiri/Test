...
?>
  ...
  <table class="table table-bordered table-hover style3 report" width="770" border="3" align="center">
  	<thead>
        ...
        <td><span class="style1">วันที่จอง</span></td>
        <td><span class="style1">รหัสการจอง</span></td>
        <td><span class="style1">รหัสสมาชิก</span></td>
        <td><span class="style1">ชื่อ - นามสกุล</span></td>
        <td><span class="style1">ค่ามัดจำ(บาท)</span></td>
        <td><span class="style1">สถานะ</span></td>
        <td><span class="style1">วันที่แจ้งเข้าพัก</span></td>
        <td><span class="style1">วันที่แจ้งออก</span></td>
        <td><span class="style1">ชื่อห้องพัก</span></td>
      </tr>
    </thead>
    <tbody> 
...
<td><? echo thaiDate($row['BK_Date']);  ?></td>
...
<td><? echo thaiDate($row['BK_DateIn']);  ?></td>
<td><? echo thaiDate($row['BK_DateOut']);  ?></td>
