...
<table width="1032" height="711" border="0" >
  ...
  <tr>
    <td width="189" height="201" align="left" valign="top" bgcolor="#999999"><h2>
      ...
      <p></p></td>
    <td width="833" height="413" align="center" valign="top" bgcolor="#D8D8D8"><h2>แสดงห้องพักที่ว่างจอง</h2>
...
$(function(){
	...
	endDateTextBox.datepicker({ 
      ...
      <form id="form1" name="form1" method="post" action="">
        ...
        ในช่วงวันที่
        <input name="txtcheckin" type="text" id="txtcheckin" value="<? echo $_POST['txtcheckin']; ?>" />
ถึงวันที่
...
<br />
      ...
      <form action="staff_booking.php" method="post" name="form1" id="form1">
