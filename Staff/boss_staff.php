...
<div id="apDiv1">
    ...
    <p>
      <input name="button" type="submit" id="button" onclick="MM_goToURL('parent','boss_addstaff.php');return document.MM_returnValue" value="เพิ่มพนักงาน" />
    </p>
</div>
<table width="1166" height="671" border="0" >
  ...
  <tr>
    <td width="189" height="201" align="left" valign="top" bgcolor="#999999"><h2>
      ...
      <p></p></td>
    <td width="967" align="center" valign="top" bgcolor="#CED8F6"><h2>แสดง/ลบข้อมูลพนักงาน</h2>
      <table width="967" height="162" border="1" align="center" bordercolor="black">
        <tr>
          <td width="83" height="23" align="center" valign="middle" nowrap="nowrap" bgcolor="#9999FF">รหัสพนักงาน</td>
          ...
          <td align="center" valign="middle" nowrap="nowrap" bgcolor="#9999FF">ตำแหน่ง</td>
          <td width="56" align="center" valign="middle" nowrap="nowrap" bgcolor="#9999FF">&nbsp;</td>
          <td width="34" align="center" valign="middle" nowrap="nowrap" bgcolor="#9999FF">&nbsp;</td>
        </tr>
 <?php
$strSQL = "select * from tb_emp";
...
?>
<tr>
<td align="center" valign="middle"><div align="center"><?php echo $objResult["Emp_ID"];?></div></td>
<td width="179" align="left" valign="middle"><?php echo $objResult["Emp_Name"];?></td>
<td width="89" align="center" valign="middle"><?php echo $objResult["Emp_Phone"]; ?></td>
<td width="146" align="center" valign="middle"><?php echo $objResult["Emp_Email"];?></td>
<td width="230" align="left" valign="middle"><?php echo $objResult["Emp_Address"];?></td>
<td width="98" align="center" valign="middle"><?php echo $objResult["Emp_Position"];?></td>
<td width="56" align="center" valign="middle"><a href="boss_editstaff.php?Emp_ID=<?php echo $objResult["Emp_ID"];?>">แก้ไข</a></td>
<td align="center"><a href="JavaScript:if(confirm('ยืนยันการลบข้อมูล?')==true){window.location='boss___delete_staff.php?Emp_ID=<?php echo $objResult["Emp_ID"];?>';}">ลบ</a></td>
