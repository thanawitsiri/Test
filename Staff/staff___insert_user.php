...
?>
<?
	if($_POST[Cus_Name] != NULL
	and $_POST[Cus_IDcard] != NULL
	and $_POST[Cus_Phone] != NULL
	and $_POST[Cus_Email] != NULL
	and $_POST[Cus_Address] != NULL){
	$sql="INSERT INTO tb_customer (Cus_ID,Cus_Name,Cus_IDcard,Cus_Address,Cus_Email,Cus_Phone,Cus_User,Cus_Pass) 
	VALUES ('NULL','".$_POST[Cus_Name]."','".$_POST[Cus_IDcard]."','".$_POST[Cus_Address]."'
	,'".$_POST[Cus_Email]."','".$_POST[Cus_Phone]."','".$_POST[Cus_IDcard]."','".$_POST[Cus_IDcard]."')";
	$query=mysql_query($sql) or die(mysql_error());
	if($query)
	{
		$str="สร้างข้อมูลลูกค้าเสร็จสิ้น";
	} 
	else
	{
	$str="สร้างข้อมูลลูกค้าล้มเหลว";
	}
}
?>
...
<table width="1163" height="671" border="0" >
  ...
  <tr>
    ...
    <td width="964" align="center" valign="top" bgcolor="#CED8F6"><h4><? echo $str; ?></h4>
      <p><a href="staff_member.php">กลับไปหน้าข้อมูลลูกค้า</a></p>
