...
<table width="962" height="744" border="0" >
  <tr>
    <td height="260" colspan="2" align="center" bgcolor="#000000"><img src="Pic/1.jpg" width="953" height="257" /></td>
  </tr>
  <tr>
    <td width="189" height="201" align="left" valign="top" bgcolor="#999999"><h2>
      ...
      <p></p></td>
    <td width="763" align="center" valign="top" bgcolor="#D8D8D8"><h2>เพิ่มข้อมูลห้องพัก</h2>
      <form id="form1" name="form1" method="post" action="staff_addroom1.php" enctype="multipart/form-data">
        <table width="451" border="0">
          <tr>
            <td>ชื่อห้องพัก<font color="red">*</font>                 : </td>
            <td><input name="Room_Name" type="text" id="Room_Name" size="15" /></td>
          </tr>
          <tr>
            <td>ประเภทห้องพัก<font color="red">*</font>         :</td>
            <td><select name="Room_Type" id="Room_Type">
<option value="F" selected="selected">Family Cottage</option>
              <option value="D">2 Bedroom Cottage</option>
</select></td>
          </tr>
          <tr>
            <td>รายละเอียดห้องพัก<font color="red">*</font>   :</td>
            <td><textarea name="Room_Detail" cols="30" rows="3" id="Room_Detail"></textarea></td>
          </tr>
          <tr>
            <td>สถานะ<font color="red">*</font>                       :</td>
            <td><select name="Room_Status" id="Room_Status">
<option value="Y" selected="selected">ใช้งานได้</option>
              <option value="N">ซ่อมแซม</option>
            </select></td>
          </tr>
          <tr>
            <td>ราคาต่อคืน*                :</td>
            <td><input name="Room_Price" type="text" id="Room_Price" align="right" size="6" />
              บาท</td>
          </tr>
          <tr>
            <td height="50">รูปภาพ                       :</td>
            <td><input type="file" name="filUpload"><br></td>
          </tr>
        </table>
        <p>
          <input name="button" type="submit" id="button" onclick="MM_goToURL('parent','staff_room.php');return document.MM_returnValue" value="ย้อนกลับ" />
          <input name="button" type="submit" id="button" onclick="MM_validateForm('Room_Name','','R','Room_Price','','R','Room_Detail','','R');return document.MM_returnValue" value="บันทึก" />
          <input type="submit" name="button" id="button6" value="ยกเลิก" />
        </p>
      </form>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
