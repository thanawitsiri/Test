...
<table width="962" height="690" border="0" >
  ...
  <tr>
    ...
    <td width="763" height="359" align="center" valign="top" bgcolor="#CED8F6">
      <form id="form1" name="form1" method="post" action="boss___update_staff.php?Emp_ID=<? echo $_GET['Emp_ID'];?>">
        <h2>แก้ไขข้อมูลพนักงาน</h2>
        <? $sql2 = "select * from tb_emp where Emp_ID = '".$_GET['Emp_ID']."'"; 
        ...
        <table width="475" border="0">
          ...
          <tr>
            ...
            <td><input name="Name" type="text" id="Name" value="<?php echo $result2["Emp_Name"];?>" /></td>
          </tr>
          <tr>
            <td>เบอร์ติดต่อ<font color="red">*</font>                        :</td>
            <td><input name="Phone" type="text" id="Phone" value="<?php echo $result2["Emp_Phone"];?>" size="15" /></td>
          </tr>
          <tr>
            <td>อีเมล<font color="red">*</font>                                 :</td>
            <td><input name="Email" type="text" id="Email" value="<?php echo $result2["Emp_Email"];?>" size="30" /></td>
          </tr>
          <tr>
            <td>ที่อยู่<font color="red">*</font>                                   :</td>
            <td><textarea name="Address" cols="30" rows="3" id="Address"><?php echo $result2["Emp_Address"];?></textarea></td>
          </tr>
        </table>
        <h3>
  ...
  <td width="248" align="left"><input name="User" type="text" id="User"value="<?php echo $result2["Emp_User"];?>" size="10" /></td>
          </tr>
          <tr>
            <td>รหัสผ่านใหม่                         :</td>
